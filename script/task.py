...
class OmniglotTask(object):
    ...
    def __init__(self, root, num_cls, num_inst, split='train'):
        ...
        self.root = '/home/oliver/Documents/loss-landscape/cifar10/data/Omniglot/all'.format(root) if split == 'train' else '/home/oliver/Documents/loss-landscape/cifar10/data/Omniglot/images_evaluation'.format(root)
        self.num_cl = num_cls
